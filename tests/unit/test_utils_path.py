...
from nova.utils.path_utils import sanitize_filename, get_safe_path, get_metadata_path, get_markdown_path, ensure_parent_dirs, get_relative_path
...
class TestPathUtils:
    ...
    def test_empty_and_invalid_filenames(self):
        ...
        test_cases = [
            ...
            ('привет\x00世界.txt', 'privet_unnamed.txt'),  # Mixed scripts with control char
