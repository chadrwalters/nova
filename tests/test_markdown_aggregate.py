...
--==ATTACHMENT_BLOCK_END==--"""
    ...
    assert "# Document" in cleaned_content
    assert "Some content" in cleaned_content
    assert "More content" in cleaned_content
    assert "--==ATTACHMENT_BLOCK:" not in cleaned_content
