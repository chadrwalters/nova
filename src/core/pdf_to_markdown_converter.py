...
def convert_pdf_to_markdown(
    pdf_path: Path, output_path: Path, media_dir: Optional[Path] = None
) -> bool:
    ...
    try:
        ...
        nova_console.process_complete("PDF conversion", stats)
...
def convert(
    ...
    media_dir: Optional[Path] = typer.Option(
        None, "--media-dir", help="Directory for extracted media"
    ),
) -> None:
