"""Process phase for Nova document processor."""
...
class ProcessPhase(Phase):
    """Process phase for document processing."""
    ...
    async def process_file(
        ...
        """Process a file in the process phase.
        ...
        try:
            ...
            # Process file
            metadata = await handler.process_file(file_path)
            if metadata:
